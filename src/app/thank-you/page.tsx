...
const ThankYouPage: React.FC<PageProps> = async ({ searchParams }) => {
  ...
  return (
    <main className="relative lg:min-h-full">
      <div className="hidden lg:block h-80 overflow-hidden lg:absolute lg:h-[93vh] lg:w-1/2 lg:pr-4 xl:pr-12">
        <Image
          fill
          src="/thankyou.jpg"
          ...
          <div className="lg:col-start-2">
            ...
            <div className="mt-16 text-sm font-medium">
              ...
              <div className="space-y-6 border-t border-gray-200 pt-6 text-sm font-medium">
                ...
                <div className="flex items-center justify-between border-t border-gray-200 pt-5 text-gray-900">
